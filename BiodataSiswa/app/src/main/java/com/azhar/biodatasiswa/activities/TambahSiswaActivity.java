...
public class TambahSiswaActivity extends AppCompatActivity {
    ...
    @BindView(R.id.edtNamaMahasiswa)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbDetailDokter.setTitle("Tambah Mahasiswa");
    ...
    private void saveData() {
        ...
        siswaModel.setNama_mahasiswa(namaSiswa);
        ...
        siswaDatabase.kelasDao().insertMahasiswa(siswaModel);
    }

    private void cekData() {
        namaSiswa = edtNamaMahasiswa.getText().toString();

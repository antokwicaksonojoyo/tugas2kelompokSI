...
public class KelasAdapter extends RecyclerView.Adapter<KelasAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tvNamaKelas .setText(kelasModel.getNama_dosen());
        holder.tvKota.setText(kelasModel.getNama_kelas());
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.edit:
                                ...
                                bundle.putString(Constant.KEY_NAMA_DOSEN, kelasModel.getNama_dosen());

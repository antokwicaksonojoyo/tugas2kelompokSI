...
public class SiswaAdapter extends RecyclerView.Adapter<SiswaAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtNameSiswa.setText(siswaModel.getNama_mahasiswa());

        // Mengambil huruf pertama
        String nama = siswaModel.getNama_mahasiswa();
        if (!nama.isEmpty()) {
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                alertDialogBuilder.setMessage("Are you sure delete " + siswaModel.getNama_mahasiswa() + " ?");
                alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {

                        // Melakukan operasi delete data
                        siswaDatabase.kelasDao().deleteMahasiswa(siswaModel);

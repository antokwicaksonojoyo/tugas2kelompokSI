...
public class UpdateKelasActivity extends AppCompatActivity {
    ...
    private void showData() {
        ...
        nama_dosen = bundle.getString(Constant.KEY_NAMA_DOSEN);

        // Menampilkan ke layar
        edtNamaKelas.setText(nama_kelas);
        edtNamaDosen.setText(nama_dosen);
    }
    ...
    private void getData() {
        ...
        nama_dosen = edtNamaDosen.getText().toString();
    }
    ...
    private void saveData() {
        ...
        kelasModel.setNama_dosen(nama_dosen);
